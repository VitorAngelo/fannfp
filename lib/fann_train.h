...
/* Struct: struct fann_data
    ...
    See also:
    <fann_read_data_from_file>, <fann_train_on_data>, <fann_destroy_data>
*/
#ifdef FANN_INFERENCE_ONLY
#define fann_reset_loss(a)
...
struct fann_data
{
    ...
    /* pointer vectors of size num_data */
    fann_type_ff **input;
    fann_type_ff **output;
};
...
FANN_EXTERNAL void FANN_API fann_gradient_check(struct fann * ann, fann_type_nt * input, fann_type_nt * output);

/* Function: fann_get_loss
...
/* Get the squared error percentage */
...
FANN_EXTERNAL float FANN_API fann_get_accuracy(struct fann *ann);

/* Function: fann_reset_loss
   Resets the mean square error from the network.
   
   This function also resets the number of bits that fail.
   
   See also:
       <fann_get_loss>, <fann_get_bit_fail_limit>
...
/* Function: fann_train_on_data
   ...
   Parameters:
           ...
           desired_error - The desired <fann_get_loss> or <fann_get_bit_fail>, depending on which stop function
...
/* Function: fann_train_epoch
   Train one epoch with a set of training data.
    ...
    This function returns the Loss as it is calculated either before or during 
    the actual training. This is not the actual loss after the training epoch, but since 
...
/* Function: fann_test_data
   ...
   Test a set of training data and calculates the loss for the training data. 
   
   This function updates the loss and the bit fail values.
   
   See also:
     <fann_test>, <fann_get_loss>, <fann_get_bit_fail>

    This function appears in FANN >= 1.2.0.
 */ 
FANN_EXTERNAL float FANN_API fann_test_data(struct fann *ann, struct fann_data *data);

/* Similar to the above, but compares if the maximum among the outputs is the same (multi-class classifier) */
FANN_EXTERNAL double FANN_API fann_test_max_data(struct fann *ann, struct fann_data *data);

/* Group: Training Data Manipulation */

/* Function: fann_read_data_from_file
   ...
   See also:
       <fann_train_on_data>, <fann_destroy_data>, <fann_save_data>

    This function appears in FANN >= 1.0.0
*/ 
FANN_EXTERNAL struct fann_data *FANN_API fann_read_data_from_file(const char *filename);


/* Function: fann_create_data
   Creates an empty training data struct.
  
   See also:
     <fann_read_data_from_file>, <fann_train_on_data>, <fann_destroy_data>,
     <fann_save_data>, <fann_create_data_array>
...
/* Function: fann_create_data_pointer_array
   ...
   See also:
     <fann_read_data_from_file>, <fann_train_on_data>, <fann_destroy_data>,
     <fann_save_data>, <fann_create_data>, <fann_create_data_array>

    This function appears in FANN >= 2.3.0
FANN_EXTERNAL struct fann_data * FANN_API fann_create_data_pointer_array(unsigned int num_data, unsigned int num_input, fann_type_nt **input, unsigned int num_output, fann_type_nt **output);
*/ 

/* Function: fann_create_data_array
   ...
   See also:
     <fann_read_data_from_file>, <fann_train_on_data>, <fann_destroy_data>,
     <fann_save_data>, <fann_create_data>, <fann_create_data_pointer_array>

    This function appears in FANN >= 2.3.0
FANN_EXTERNAL struct fann_data * FANN_API fann_create_data_array(unsigned int num_data, unsigned int num_input, fann_type_nt *input, unsigned int num_output, fann_type_nt *output);
*/ 

/* Function: fann_create_data_from_callback
   ...
   and returns the set.  fann_create_data_from_callback will call the user
...
FANN_EXTERNAL struct fann_data * FANN_API fann_create_data_from_callback(unsigned int num_data,
                                          unsigned int num_input,
                                          unsigned int num_output,
...
/* Function: fann_destroy_data
   ...
   Be sure to call this function when finished using the training data.
    ...
    This function appears in FANN >= 1.0.0
 */ 
FANN_EXTERNAL void FANN_API fann_destroy_data(struct fann_data *train_data);

/* Function: fann_get_data_input
   Gets the training input data at the given position

   See also:
     <fann_get_data_output>

   This function appears in FANN >= 2.3.0
 */ 
FANN_EXTERNAL fann_type_ff * FANN_API fann_get_data_input(struct fann_data * data, unsigned int position);

/* Function: fann_get_data_output
...
/* Function: fann_get_min_data_input
...
/* Function: fann_get_max_data_input
...
/* Function: fann_get_min_data_output
...
/* Function: fann_get_max_data_output
...
FANN_EXTERNAL unsigned int fann_count_classes(struct fann_data * data, unsigned int ** class_count,
        float threshold, unsigned int * max_idx, unsigned int * min_idx);
...
/* Function: fann_scale_input_data_linear
   ...
   See also:
       <fann_scale_output_data_linear>, <fann_scale_data_linear>, <fann_scala_input>
...
/* Function: fann_scale_output_data_linear
   ...
   See also:
       <fann_scale_input_data_linear>, <fann_scale_data_linear>
...
/* Function: fann_scale_data_linear
   ...
   See also:
       <fann_scale_output_data_linear>, <fann_scale_input_data_linear>

   This function appears in FANN >= 2.0.0.
FANN_EXTERNAL void FANN_API fann_scale_data_linear(struct fann_data *train_data,
                                                  fann_type_nt new_min, fann_type_nt new_max);
 */ 
#endif // FANN_DATA_SCALE


/* Function: fann_merge_data
   
   Merges the data from *data1* and *data2* into a new <struct fann_data>.
...
/* Function: fann_duplicate_data
   
   Returns an exact copy of a <struct fann_data>.
...
/* Function: fann_subset_data
   
   Returns an copy of a subset of the <struct fann_data>, starting at position *pos* 
   and *length* elements forward.
   
   >fann_subset_data(train_data, 0, fann_length_data(train_data))
   
   Will do the same as <fann_duplicate_data>.
...
/* temporary hack to return a quick reference to internal data 
FANN_EXTERNAL struct fann_data *FANN_API fann_getref_data(struct fann_data *data, unsigned int pos); */

/* Function: fann_length_data
   
   Returns the number of training patterns in the <struct fann_data>.

   This function appears in FANN >= 2.0.0.
 */ 
FANN_EXTERNAL unsigned int FANN_API fann_length_data(struct fann_data *data);
    
/* Function: fann_num_input_data
   
   Returns the number of inputs in each of the training patterns in the <struct fann_data>.
   
   See also:
       <fann_num_train_data>, <fann_num_output_data>

   This function appears in FANN >= 2.0.0.
 */ 
FANN_EXTERNAL unsigned int FANN_API fann_num_input_data(struct fann_data *data);
    
/* Function: fann_num_output_data
   
   Returns the number of outputs in each of the training patterns in the <struct fann_data>.
   
   See also:
       <fann_num_train_data>, <fann_num_input_data>

   This function appears in FANN >= 2.0.0.
 */ 
FANN_EXTERNAL unsigned int FANN_API fann_num_output_data(struct fann_data *data);
    
/* Function: fann_save_data
   
   Save the training structure to a file, with the format as specified in <fann_read_data_from_file>

   Return:
   The function returns 0 on success and -1 on failure.
      
   See also:
       <fann_read_data_from_file>, <fann_save_data_to_fixed>
...
//FANN_EXTERNAL void FANN_API fann_set_mini_batch(struct fann *ann, unsigned int mini);
...
/* Function: fann_get_activation_steepness
   ...
   This function appears in FANN >= 2.1.0
FANN_EXTERNAL float FANN_API fann_get_activation_steepness(struct fann *ann,
                                                                int layer,
                                                                int neuron);
 */ 
...
/* Function: fann_get_train_stop_function
   ...
   The default stop function is FANN_STOPFUNC_LOSS
